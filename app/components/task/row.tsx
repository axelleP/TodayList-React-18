...
export default function Row({ id, task }: InfoProps) {
  ...
  return (
    <tr className="bg-slate-100">
      ...
      <td className="text-center"><button type="submit" className="bg-rose-600 hover:bg-rose-700 active:bg-rose-800 rounded-sm text-white px-2">x</button></td>
    </tr>
  );
}
